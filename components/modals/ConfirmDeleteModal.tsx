...
import { useDeleteTourMutation } from "@/redux/api/tourApi";
...
export default function ConfirmDeleteModal({ tourId, tourTitle, isOpen, onClose }: ConfirmDeleteModalProps) {
    ...
    const handleDelete = async () => {
        try {
            ...
            if (res.success) {
                toast.success(`Successfully removed "${tourTitle}"`);
                onClose();
            }
        } catch (error: any) {
            toast.error(error?.data?.message || `Failed to delete "${tourTitle}"`);
        }
    };
                ...
                <div className="p-10 space-y-8 text-center">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-slate-500 font-medium leading-relaxed">
                            ...
                            <span className="text-red-500 font-black italic">"{tourTitle}"</span>?
                        </p>
                        <div className="bg-amber-50 border border-amber-100 p-4 rounded-2xl flex gap-3 text-left animate-in slide-in-from-top-2 duration-500">
                            ...
                            <p className="text-[11px] text-amber-700 font-bold leading-relaxed">
                                ...
                                The package will be hidden from all dashboards immediately.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-3 pt-2">
                        ...
                        >
                            ...
                            {isDeleting ? "Deleting Package..." : "Confirm Deletion"}
                        </button>
