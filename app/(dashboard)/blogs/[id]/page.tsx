...
import { ArrowLeft, Clock, Tag, Calendar, Edit2, Trash2, Heart, Loader2 } from "lucide-react";
...
export default function BlogDetailsPage() {
    ...
    const { data: response, isLoading } = useGetSingleBlogQuery(blogId, { skip: !blogId });
    ...
    if (isLoading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh]">
                ...
                <p className="text-slate-500 font-medium mt-4 animate-pulse">Loading blog details...</p>
            </div>
        );
    }
